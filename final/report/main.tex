...
% \caption{Toàn bộ tiến trình pre-training và fine-tuning của BERT.}
% \end{center}
% \end{figure}
% \FloatBarrier
...
% Masked ML là một tác vụ cho phép chúng ta fine-tuning lại các biểu diễn từ trên các bộ dữ liệu unsupervised-text bất kỳ. Chúng ta có thể áp dụng Masked ML cho những ngôn ngữ khác nhau để tạo ra biểu diễn embedding cho chúng.
% \begin{figure}[!htb]
% \begin{center}
